...
rd
rd <- rd[elementMetadata(rd)[,4]>100]
...
head(gene_variants)
gene_variants
#gene_variants2 <- gene_variants

del_variants <- subset(gene_variants, ALT=="<DEL>")
del_variants$seqnames <- gsub("^","chr",del_variants$seqnames)

#del_variants2 <- del_variants
#del_variants2 <- as.factor(del_variants2)
#table(del_variants2)
#geno(VariantAnnotation::header(del_variants2))["GT",]
#GT_del <- geno(del_variants2)$GT
...
breaks_variants 
strsplit(breaks_variants,split = "<ALT>")
gsub(breaks_variants)
```
...
#track.num <- 5
#RCircos.Link.Plot(RCircos.Link.Data, track.num = 5)

#data(RCircos.Ribbon.Data)
#RCircos.Ribbon.Plot(RCircos.Ribbon.Data,track.num = 5, by.chromosome = FALSE, twist = FALSE)
