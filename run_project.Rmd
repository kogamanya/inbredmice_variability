...
#yet to figure out the right way to locate the gene variants, but continue to annotate using the gff file.

#all <- locateVariants(gt, txdb, AllVariants())
