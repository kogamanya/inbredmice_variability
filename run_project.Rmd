...
rownames(gtx) <- paste(gt3$seqnames,gt3$start,gt3$END,gt3$alt) #changes to be made here in order to have venn diagram on the codes
gtx
...
RCircos.Tile.Plot(tile.data=breaks_variants, track.num=3, side="in") #changes made here
