---
title: "Research analysis on short tandem repeats (STRs)"
...
variants <- readr::read_tsv("str_res/SRP199233_merge.outlier_locus.tsv", col_names = TRUE,show_col_types =FALSE,skip_empty_rows = TRUE)
...
write.table(x=str_regions,file="str_regions.bed",quote=FALSE,sep="\t", col.names = FALSE,row.names = FALSE)
