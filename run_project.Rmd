...
```{r, locate variants}
#using any of this package to locate variants in and around genes
...
rownames(gt2) <- paste(df$seqnames,df$start,sep=":")
rownames(gt2)
colfunc <- colorRampPalette(c("yellow", "blue", "red"))
heatmap.2(head(gt2, 100), trace = "none", scale = "none", dendrogram='none', Rowv=FALSE, Colv=FALSE, col=colfunc(25), margins = c(5,10), cexRow=.8, cexCol=.9,  main="Genetic Variation")
